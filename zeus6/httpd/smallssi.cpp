...
void xtest1()
{
    printf("<html><head><title>xtest1</title></head>\n<body bgcolor=\"#66ffff\"><h4>XTEST1</h4></body></html>" );
}
...
struct internal_fn_t {
	char * cname ;
	void (* func)() ;
} internal_fn[] = { { "xtest1",  xtest1 }, {NULL,NULL} } ;
...
int http_checkcache()
{
    ...
    http_setheader( "Cache-Control", "max-age=3600" );
...
void http_document()
{
       ...
       strcmp(&script_filename[len-4], ".ssi")==0 )
    {
        ...
        http_response( 200, NULL, get_mime_type( script_name ), len );
