...
#define LIVEVIEW_MAIN           (0)
#define LIVEVIEW_SUB            (1)
#define PLAYBACK_MAIN           (0)
#define PLAYBACK_SUB            (1)
...
struct dvr_key_t {
    int ktime;		
   // key frame time, in milliseconds, from start of file(file time in filename)
...
extern int cap_totalrate;
extern int cap_totalenabled;
void cap_start();
void cap_stop();
...
class capture {
  protected:
   ...
   //add for osd start
    ...
    int         m_eventTriggerEnable;
    int         m_gforceCrashTriggerEnable;
    int 	m_emk_send_enable;
    int 	m_gforce_send_enable;
    int         SecondStreamEn;
    int         SecondRecordingEn;
    int         FrameRate_Second;
    int         Resolution_Second;
    int         Bitrate_Second;
    int         Liveview_stream;   
    int         Tab102_enable;
  ...
  public:
    ...
    int eventMarkerRecordingEnabled(){
        return m_eventTriggerEnable; 
    }
    int gforceCrushRecordingEnabled(){
         return m_gforceCrashTriggerEnable;
    }
    int emkSendEnabled(){
        return m_emk_send_enable;
    }
    int gforceSendEnabled(){
        return m_gforce_send_enable;
    }
    int isworking(){
        return --m_working>0 ;
    }
...
void dio_setdiskexist();
void dio_cleardiskexist();
