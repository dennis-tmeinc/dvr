/* --- Changes ---
 *
 * 01/14/2011 by Harrison
 *   1. time in UTC on both Internal/External GForce. 
 *   2. added event trigger sanity check
 *  
 */
