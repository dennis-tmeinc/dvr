...
class dvrfile {
  protected:
    ...
    int   m_filesize ;
	int   m_filelen ;			// file length in time
  ...
  public:
    ...
    int reapirpartiallock(int length, int locklength) ;
	int tell();
...
time_t time_localtime(struct dvrtime *dvrt);	// same as time_now()
