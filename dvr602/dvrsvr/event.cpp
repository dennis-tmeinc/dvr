...
double g_gpsspeed ;
double g_fb, g_lr, g_ud = 999.9;

extern int get_peak_data( double *fb, double *lr, double *ud );
...
sensor_t::sensor_t(int n) 
{
    ...
    m_rising = dvrconfig.getvalueint(section, "on_rising");
    m_falling = dvrconfig.getvalueint(section, "on_falling");
    m_immobile = dvrconfig.getvalueint(section, "on_immobile");
}
