...
struct BITMAP {
	...
	int bytes_per_line ;
	UINT8 * bits ;			// pixel data, bottom up bitmaps. (compatible with .bmp file)
} ;
...
int draw_readbitmap(struct BITMAP * bmp, int x, int y, int w, int h );		// capture bitmap from screen
