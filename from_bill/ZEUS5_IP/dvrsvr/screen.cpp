...
//    ClrDisplayParams(MAIN_OUTPUT,0);
 ...
 //   res=SetDisplayOrder(MAIN_OUTPUT, displayorder );
    res=SetDisplayParams(ScreenNum);
    
    SetPreviewScreen(0,1);
    SetPreviewAudio(0,1);//(m_screen,1);
}
...
class video_screen : public window {
    ...
    video_screen( window * parent, int id, int x, int y, int w, int h ) :
        window( parent, id, x, y, w, h ) 
     {
	   ...
	   //  SetPreviewScreen(0,1);//(m_screen,1);
	...
	//   SetPreviewScreen(m_screen,0);
	//   SetPreviewAudio(m_screen,0);
         }
     }
    ...
    mainwin() :
        window( NULL, 0, 0, 0, 720, 480 )
     {
         ...
         if( ScreenNum==1 ) {
             ...
             vs = new video_screen( this, SCREEN_ID+1, 10,  10, 350, 240 );
             vs->select(1);
             vs = new video_screen( this, SCREEN_ID+2, 360, 10, 350, 240 );
             vs = new video_screen( this, SCREEN_ID+3, 10,  240, 350, 240 );
             vs = new video_screen( this, SCREEN_ID+4, 360, 240, 350, 240 );
         }
         else if(ScreenNum==9){

             vs = new video_screen( this, SCREEN_ID+1, 10,  10, 230, 160 );
             vs->select(1);
             vs = new video_screen( this, SCREEN_ID+2, 240, 10, 230, 160 );
             vs = new video_screen( this, SCREEN_ID+3, 470, 10, 230, 160 );

             vs = new video_screen( this, SCREEN_ID+4, 10,  160, 230, 160 );
             vs = new video_screen( this, SCREEN_ID+5, 240, 160, 230, 160 );
             vs = new video_screen( this, SCREEN_ID+6, 470, 160, 230, 160 );

             vs = new video_screen( this, SCREEN_ID+7, 10,  320, 230, 160 );
             vs = new video_screen( this, SCREEN_ID+8, 240, 320, 230, 160 );
             vs = new video_screen( this, SCREEN_ID+9, 470, 320, 230, 160 );
...
//    ScreenNum = dvrconfig.getvalueint("VideoOut", "screennum" );
     ScreenNum = dvrconfig.getvalueint("system", "screen_num" );
