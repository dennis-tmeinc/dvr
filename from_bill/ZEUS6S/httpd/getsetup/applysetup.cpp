...
void setuserpassword()
{
    ...
    system("cp /etc/passwd /mnt/nand/dvr/passwd");
}
...
int main()
{
	...
	v=getsetvalue( "disk_number" );
	if( v ) {
	    dvrconfig.setvalue("system","numberofdiskused",v);
	}        
	v=getsetvalue( "partitions_perdisk" );
	if( v ) {
	    dvrconfig.setvalue("system","partitionperdisk",v);
	}   
